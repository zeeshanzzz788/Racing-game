...
| `Endless/EndlessTrackGenerator.cs` | Forward segment lifecycle and pickup/hazard placement. | Introduce object pooling, weighted segment connectors, traffic and biome rules. |
